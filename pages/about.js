  ...
  return (
    <Layout>
      ...
      <p style={{paddingLeft: '10%  !important', paddingRight: '10%  !important'}}>
	      ...
	      keep the servers up and allow us to add new features. Follow us <a href="https://twitter.com/langmap_me"> on Twitter @langap_me! </a> 
      </p>
      <center> <h2> How many languages are available? </h2> </center>
      <p style={{paddingLeft: '10%  !important', paddingRight: '10%  !important'}}>
	      There are currently eighty languages that can be mapped on LangMap. 
